...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="openai/whisper-small", help="Hugging Face Model name, or directory to the model")
    parser.add_argument("--dataset_name", type=str, default="mozilla-foundation/common_voice_13_0", help="Name of the dataset from Hugging Face")
    parser.add_argument("--config", type=str, default="vi_vn", help="Dataset configuration. Ex 'vi_vn' for Google Fleurs")
    parser.add_argument("--language", type=str, default="vi", help="Language for transcription")
    parser.add_argument("--device", type=int, default=0, help="GPU ID (ex: 0), to use CPU use (-1)")
    parser.add_argument("--split", type=str, default="test", help="The split to evaluate on. (ex: 'test')")
    parser.add_argument("--output_dir", type=str, default="whisper_eval", help="Directory to save the evaluation results")
